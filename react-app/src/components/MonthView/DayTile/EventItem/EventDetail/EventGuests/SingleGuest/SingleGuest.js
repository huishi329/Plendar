    ...
    return (
        ...
        <div key={guest.id} className={styles.wrapper}>
            <div className={styles.image}>
                ...
                {guest.status === 'no' && <i class="fa-regular fa-circle-xmark" style={{ color: '#d93025', backgroundColor: 'rgba(234,67,53, 0.3)' }}></i>}
                ...
                {guest.status === 'awaiting' && <i class="fa-solid fa-spinner" style={{ fontSize: 12 }}></i>}
            </div>
            {
