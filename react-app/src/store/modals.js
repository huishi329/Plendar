...
const SET_LANDING_MODAL = 'modals/setLadningModal';
...
export const setLandingModal = showLandingModal => {
    return { type: SET_LANDING_MODAL, showLandingModal };
};
...
export default function modalsReducer(state = {}, action) {
    switch (action.type) {
        case SET_SIGNUP_MODAL:
            return { showSignUpModal: action.showSignUpModal };
        case SET_SIGNIN_MODAL:
            return { showSignInModal: action.showSignInModal };
        case SET_DELETE_CALENDAR_MODAL:
            return { ...state, showDeleteCalendarModal: action.showDeleteCalendarModal };
        case SET_LANDING_MODAL:
            return { showLandingModal: action.showLandingModal };
